...
<body>
	<form action="save.html" name="happyForm" id="happyForm" target="result" method="post">
		<input type="hidden" name="happyPoollId" id="happyPoollId" value="${happyPooll.happyPoollId}">
	<table border="0" cellpadding="0" cellspacing="0">
		<tr class="info">
		<th>热词名称:</th>
			<td>
				<input type="text" name="happyPoollName" id="happyName"  value="${happyPooll.happyPoollName}" style="width:155px">
		...
		<th>热词顺序:</th>
			<td>
				<input type="text" disabled="disabled" id="happyPoollorder"  value="${happyPooll.happyPoollorder}" style="width:155px">
				<label style="color: red;" class="red">*</label>
			</td>
		</tr>
	</table>
