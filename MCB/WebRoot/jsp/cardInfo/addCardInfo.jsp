...
<body>
	<form  action="saveCardInfo.html" enctype="multipart/form-data" name="CardInfoForm" id="CardInfoForm" target="result"  method="post">
	<table border="0" cellpadding="0" cellspacing="0">
 	<tr class="info">
 		<th>产品编码:</th>
			<td><input type="text" name="cardNum" maxlength="30" id="cardNum" class="input_txt"/>
			<label style="color: red;" class="red">*</label></td>
		<th>产品名称:</th>
			<td><input type="text" maxlength="50" name="cardNmae" id="cardNmae" class="input_txt"/>
			<label style="color: red;" class="red">*</label></td>
	</tr>
	<tr class="info">
		<th>产品类型:</th>
	...
	<!-- <tr class="info">
				<th>是否可加办卡:</th>
		 		<td>
			 	<select name="cardIsAdd" id="cardIsAdd" style="width:205px;">
					<option value="">请选择</option>
				   <option value="1">可加办卡</option>
				   <option value="2">不可加办卡</option>
