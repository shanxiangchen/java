...
<script type="text/javascript" src="../js/errorCode/errorCode_insert.js"></script>
...
<body>
	...
	<table border="0" cellpadding="0" cellspacing="0">
		...
		<tr class="info">
			<th>错误编码:</th>
			<td><input type="text" name="errorEncoding" id="errorEncoding" class="input_txt" style="width:150px;"/>
			<label style="color: red;" class="red">*</label>
			</td>
		</tr>
		<tr class="info">
			<th>错误编码描述:</th>
		<td>
		<textarea name="errorDescribe" id="errorDescribe" style="width:150px;"></textarea>
		<label style="color: red;" class="red">*</label>
		</tr>
	</table>
	</form>
