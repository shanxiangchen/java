...
<body>
	<form action="saveAllMessageParameterConf.html" name="MessageTemplateForm" id="MessageTemplateForm" target="result" method="post"  enctype="multipart/form-data" >
		<table border="0" cellpadding="0" cellspacing="0">
			<tr class="info">
				<th>消息盒子名称:</th>
				<td>
					<input type="text" id="bmpcName" name="bmpcName"   class="input_txt" maxlength="150"/>
			...
			<tr class="info">
				<th>消息编码:</th>
				<td><input type="text" id="bmpcCode" name="bmpcCode"  class="input_txt" maxlength="5"/>
				<label style="color: red;" class="red" >*</label>
				</td>
			</tr>
			<tr class="info">
				<th>消息盒子类型:</th>
				<td>
				 <select name="bmpcType"  style="width:197px;line-height:25px;" id="bmpcTypeName" >
