...
<body>
	...
	<div class="main_content" >
		<div class="content_left"  style='border:0px;padding:3px; PADDING:0px; width:200px; height:530px; LINE-HEIGHT: 20px; OVERFLOW: auto; '>
		...
		<div class="content_right">
			...
			<div class="sys_bottom" style="padding:0px 400px;"> Copyright &copy; 2015 兴业银行APP信用卡后台管理系统</div>
		</div>
	</div>
