	...
	<form action="updateOkAdvert.html" name="advertForm" id="advertForm" target="result" method="post"  enctype="multipart/form-data">
 	  <div align="center">
 	    ...
 	    <tr>
 	       ...
 	       <td align="left">
 	       		<input type="text" id="advertUrl" name="advertUrl" value="${li.advertUrl}" maxlength="100"/><br><br>
 	       </td> 	     
 	      </tr>
 	     <tr>
 	       <td align="right">链接参数:<br><br></td>
 	       <td align="left">
 	       		<input type="text" id="advertParam" name="advertParam" value="${li.advertParam}" maxlength="100"/><br><br>
 	       </td> 	     
 	      </tr>
 		 </c:forEach>
 	    </c:forEach>
