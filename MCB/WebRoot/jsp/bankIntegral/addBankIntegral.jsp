...
<body>
	<form action="saveBankIntegral.html"  name="bankIntegralForm" id="bankIntegralForm" target="result" enctype="multipart/form-data" method="post">
	<table border="0" cellpadding="0" cellspacing="0">
		<tr class="info">
			...
			<td>
				<select id="integralType" name="integralType"  class="input_txt">
					...
					<option value="1">赚积分</option>
					<option value="0">花积分</option>
				</select>
			<label style="color: red;" class="red">*</label>
			</td>
		</tr>
		<tr class="info">
			<th>积分详情:</th>
		<td colspan="3">
		<textarea name="integralDetailsPc" id="integralDetailsPc" style="width:100%;height:60px;visibility:hidden;"></textarea>
		</td>
		</tr>
		<tr>
		  <td align="right"></td>
...
var editor;
		...
		$(document).ready(function(){
			...
			dg.addBtn('ok','保存',function(){
				if($("#integralImgRul").val()==""){
					alert("带有*号的必填!");
					$("#integralImgRul").focus();
					return false;
				}
				if($("#integralType").val()==""){
					alert("带有*号的必填!");
