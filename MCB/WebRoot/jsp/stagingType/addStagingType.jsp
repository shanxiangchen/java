...
<script type="text/javascript" src="../js/stagingType/stagingType_add.js"></script>
...
<body>
	...
	<table border="0" cellpadding="0" cellspacing="0">
		<tr class="info">
			<th>分期类型编码:</th>
			<td>
				<input type="text" name="stagCode" id="stagCode" style="width:155px"/>
		...
		<th>分期类型名称:</th>
			<td>
				<input type="text" name="stagName" id="stagName"  style="width:155px">
				<label style="color: red;" class="red" >*</label>
			</td>
		</tr>
	</table>
