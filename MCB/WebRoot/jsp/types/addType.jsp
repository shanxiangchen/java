...
<body>
	<form  action="save.html" name="typeForm" id="typeForm" 
	target="result" method="post" onsubmit="return checkInfo();">
		<input type="hidden" name="oddsshoptypeid" id="oddsshoptypeid" />
	<table border="0" cellpadding="0" cellspacing="0">
	
		 <tr class="info">
		<th>名称:</th>
		<td><input id="oddsshoptype" name="oddsshoptype" class="input_txt"  > 
