 	 ...
 	 <div align="center">
 	  <table>
 	    ...
 	    <tr>
 	       ...
 	       <td align="left">
 	       		<input type="hidden" id="advertUrl1" value="" name="advertUrl1" maxlength="480"/>
 	       		<input type="text" id="advertUrl" disabled="disabled" value="" name="advertUrl" maxlength="480"/><br><br>
 	       </td> 	     
 	    </tr>
 	     <tr>
 	       <td align="right">链接参数:<br><br></td>
 	       <td align="left">
 	       		<input type="text" id="advertParam" disabled="disabled" name="advertParam" maxlength="180" placeholder="adverId=123,adverNo=32432"/><br><br>
 	       </td> 	     
 	    </tr>
	  </table>
 	</div>
