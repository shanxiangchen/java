...
<body>
	<form  action="save_messageAllocation.html" enctype="multipart/form-data" name="addMessageAllocationForm" id="addMessageAllocationForm" target="result"  method="post">
	  <table border="0" cellpadding="0" cellspacing="0" id="tableId">
	  	<input type="hidden" name="messageId" id="messageId" value="${bankMessageAllocation.messageId}"/>
	  </table>  
	  <div id="aa">
	     <table border="0" cellpadding="0" cellspacing="0">
		     <tr class="info">
		     	<th>配置名称：</th>
		     	<td></td>
		     	<td><input type="text" value="${messageAllocation.allocationName}" name="allocationName" id="allocationName" class="input_txt"/>
		     	<label style="color: red;" class="red">*</label></td>
	 		 </tr>
		     <tr class="info">
		     	<th>code码：</th>
		     	<td></td>
		     	<td><input type="text" value="${messageAllocation.messageCode}" name="messageCode" readonly="readonly"  disabled="disabled" id="messageCode" maxlength="6"  class="input_txt" onchange="javascript:testmessageCode()"/>
	 		  ...
	 		  <tr class="info">
	 		  	<th>允许推送次数：</th>
	 		  	<td></td>
	 		  	<td><input type="text" value="${messageAllocation.times}" name="times" id="times" class="input_txt"/></td>
	 		  </tr>
	 		  <tr class="info">
	 		  	<th>推送间隔(s):</th>
	 		  	<td></td>
	 		  	<td><input type="text" value="${messageAllocation.intervalTime}" name="intervalTime" id="intervalTime" class="input_txt" placeholder="以秒计算"/></td>
	 		  </tr>
	     </table>
	  </div>  
    </form>			
