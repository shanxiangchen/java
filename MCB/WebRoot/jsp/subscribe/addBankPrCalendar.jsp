...
<body>
	<form action="saveCalendar.html" name="addInfoForm"
		id="addInfoForm" target="result" method="post">
		<table border="0" cellpadding="0" cellspacing="0" align="center">
		 <tr class="info">
		    <th>假期类型:</th>
			<td>
			 <select name="calendarType" id="calendarType" style="width:150px;">
				<option value="">请选择</option>
				<option value="YD">元旦</option>
				<option value="CJ">春节</option>
				<option value="QM">清明</option>
				<option value="WY">五一</option>
				<option value="DW">端午</option>
				<option value="ZQ">中秋</option>
				<option value="GQ">国庆</option>
		...
		<tr class="info">
		    <th>年份:</th>
		    <td>
		     <input type="text" name="calendarYear" id="calendarYear"  onclick="display()" readonly="readonly" style="background-image:url(../images/xiao.gif);background-repeat:no-repeat;background-position:right center;height:20px;width:150px;padding:0px"/>
		      <label style="color: red;" class="red">*</label>
		    </td>
		</tr>
		<tr class="info">
		   <th>开始日期:</th>
			<td>
			 <input type="text" name="calendarBeginDate" id="calendarBeginDate"
				  onclick="displayShow()"
		 ...
		 <tr class="info">
		    <th>结束日期:</th>
		    <td>
				<input type="text" name="calendarEndDate" id="calendarEndDate"
				 onclick="displayShow()"
				style="background-image:url(../images/xiao.gif);   background-repeat:no-repeat;background-position:right center;width:150px;height: 20px; padding:0px;"
				readonly="readonly" /> <label style="color: red;" class="red">*</label>
			</td>
